...
local SYRIA_Msg = ''  
if msgs < 100 then 
SYRIA_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
SYRIA_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
SYRIA_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
SYRIA_Msg = 'متفاعل' 
elseif msgs < 1200 then 
SYRIA_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
SYRIA_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
SYRIA_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
SYRIA_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
SYRIA_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
SYRIA_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
SYRIA_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
SYRIA_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
SYRIA_Msg = 'رب التفاعل'  
end 
return SYRIA_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceSYRIA(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,SYRIA_Msg) 
return false  
end 
if text then    
...
os.execute('wget https://raw.githubusercontent.com/ahmedyad200/dived/master/SYRIA.lua')
send(msg.chat_id_, msg.id_,'❈ تم تحديث السورس \n❈ لديك اخر اصدار ل𝐒𝐎𝐔𝐑𝐂𝐄  SYRIA\n❈ الاصدار » { 1.3v}')
dofile('SYRIA.lua')  
end
if text == 'الاصدار❈' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'❈ اصدار𝐒𝐎𝐔𝐑𝐂𝐄  SYRIA \n❈ الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت❈' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'❈ [تحديثات البوت](t.me/SOURCE_SYRIA) \n❈ [قناه السورس](t.me/SOURCE_SYRIA)')
end
...
send(msg.chat_id_, msg.id_,'❈  عدد الجروبات الان » { '..#group..' }'..SYRIAk..''..SYRIA..'\n❈  الان عدد الجروبات الحقيقي » { '..sendok..' } جروبات\n')   
end
end
end,nil)
end
...
local SYRIA1_Msg = database:get(bot_id.."SYRIA1:Add:Filter:Rp2"..text..msg.chat_id_)   
if SYRIA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if SYRIA_Msg and not Special(msg) then  
local SYRIA_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if SYRIA_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
{{text = ' Channel ',url="t.me/SOURCE_SYRIA"}}, 
{{text = ' Developer¹ ', url="t.me/SIRIA199"}}, 
{{text =  '  Continue source  ', url="t.me/twasol6bot"}}, 
} 
...
send(msg.chat_id_, msg.id_,"❈ عذرا الملف لا يدعم سورس سوريا \n") 
end
return false
end
...
local UserName = (b.username_ or "SOURCE_SYRIA")
...
database:set(bot_id.."SYRIA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."SYRIA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"❈ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."SYRIA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."SYRIA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."SYRIA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."SYRIA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"❈ تم منع الكلمه مع التحذير")  
database:del(bot_id.."SYRIA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."SYRIA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."SYRIA1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."SYRIA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"❈ ارسل الكلمه الان")  
database:set(bot_id.."SYRIA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."SYRIA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."SYRIA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SYRIA1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."SYRIA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."SYRIA1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."SYRIA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SYRIA1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."SYRIA1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n❈ قائمة المنع \n◎ ══════ ❈ ══════ ◎\n"
for k,v in pairs(list) do  
local SYRIA_Msg = database:get(bot_id.."SYRIA1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..SYRIA_Msg.."}\n"    
end  
if #list == 0 then  
...
send(msg.chat_id_, msg.id_,'['..SYRIA_Msg[math.random(#SYRIA_Msg)]..']') 
return false
end
...
if text == 'صاحب التلجرام' or text == 'سوريا' or text == 'صاحب التليجرام' then
local Text = [[
❈┃صاحب التلجرام يمكنك..💓
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'صاحب التليجرام',url="t.me/SOURCE_SYRIA"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
-- vardump(data) 
SYRIAdx(msg.chat_id_, msg.id_, '❈ ايدي المجموعة » ( '..msg.chat_id_..' )\n❈ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n❈ عدد المحظورين » ( *'..data.kicked_count_..' )*\n❈ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
local Text =[[
➫ ┇[𝐒𝐎𝐔𝐑𝐂𝐄  SYRIA❈](t.me/SOURCE_SYRIA)
──┈┈┈┄┄╌╌╌╌┄┄┈┈┈
...
❿◂ اوامر الاعضاء 
 ───────❈ ───────
 ➫ ┇[𝐒𝐎𝐔𝐑𝐂𝐄  SYRIA❈](t.me/SOURCE_SYRIA)
[➫ ┇صاحب التلجرام❈](t.me/SOURCE_SYRIA)
 ───────❈ ───────
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄  SYRIA ', url="t.me/SOURCE_SYRIA"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
zh = https.request('https://rudi-dev.tk/Amir1/SYRIA.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n❈ قائمه الزخرفه \nٴ❈╭—──── •❈ • ──—–—╮❈○ٴ \n"
i = 0
...
gk = https.request('https://rudi-dev.tk/Amir2/SYRIA.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://rudi-dev.tk/Amir3/SYRIA.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
❈┃التاريخ
 ───────❈ ───────
 ➫ ┇[𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝑳𝐉𝐀𝐑??𝐇❈](t.me/SOURCE_SYRIA)
[➫ ┇صاحب التلجرام❈](t.me/SOURCE_SYRIA)
 ───────❈ ───────
]]
keyboard = {} 
...
SYRIA = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(SYRIA)
...
--------------------------------------------------------------------------------------------------------------
SourceSYRIA(data.message_,data)
...
------------------------------------------------------------------------
local SYRIAAbot = database:get(bot_id.."SYRIA1:Add:Filter:Rp2"..text..result.chat_id_)   
if SYRIAAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"❈ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n❈ ["..SYRIAAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local SYRIA1_Msg = database:get(bot_id.."SYRIA1:Add:Filter:Rp2"..text..result.chat_id_)   
if SYRIA1_Msg then    
send(msg.chat_id_, msg.id_,"❈ "..SYRIA1_Msg)
